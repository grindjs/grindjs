...
test('arguments:required', t => {
	...
	command.arguments = [new InputArgument('arg', InputArgument.VALUE_REQUIRED)]
...
test('arguments:optional', t => {
	const command = new Command()
	command.arguments = [new InputArgument('arg', InputArgument.VALUE_OPTIONAL)]
...
test('arguments:default', t => {
	const command = new Command()
	command.arguments = [new InputArgument('arg', InputArgument.VALUE_OPTIONAL, null, 'def')]
...
test('options:optional', t => {
	const command = new Command()
	command.options = [new InputOption('opt', InputOption.VALUE_OPTIONAL)]
...
test('options:default', t => {
	const command = new Command()
	command.options = [new InputOption('opt', InputOption.VALUE_OPTIONAL, null, 5)]
...
test('options:flag', t => {
	const command = new Command()
	command.options = [new InputOption('opt', InputOption.VALUE_NONE)]
